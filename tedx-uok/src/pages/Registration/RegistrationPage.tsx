                ...
                <div className="mb-6 bg-green-900/20 border border-green-500 rounded-xl p-6">
                  <div className="flex items-start space-x-4 mb-4">
                    ...
                    <div className="flex-1">
                      <h3 className="text-white font-bold text-xl mb-2" style={{ letterSpacing: '0' }}>Registration Successful!</h3>
                      <p className="text-gray-300 mb-4" style={{ letterSpacing: '0' }}>Thank you for registering for TED<sup>x</sup> UoK! Your spot is reserved.</p>
                      ...
                      <div className="bg-black/30 rounded-lg p-4 mb-4">
                        ...
                        <div className="space-y-3">
                          <div className="flex items-start space-x-3">
                            ...
                            <div>
                              <p className="text-gray-300 text-sm" style={{ letterSpacing: '0' }}><strong>Immediately:</strong> Check your email for registration confirmation and ticket details</p>
                            </div>
                          </div>
                          <div className="flex items-start space-x-3">
                            ...
                            <div>
                              <p className="text-gray-300 text-sm" style={{ letterSpacing: '0' }}><strong>Payment (if required):</strong> Complete payment via the link in your email within 24 hours</p>
                            </div>
                          </div>
                          <div className="flex items-start space-x-3">
                            ...
                            <div>
                              <p className="text-gray-300 text-sm" style={{ letterSpacing: '0' }}><strong>Event Day:</strong> Bring your ticket (email or printed) and a valid ID</p>
                            </div>
                          </div>
                          <div className="flex items-start space-x-3">
                            ...
                            <div>
                              <p className="text-gray-300 text-sm" style={{ letterSpacing: '0' }}><strong>Stay Updated:</strong> Follow us on social media for event updates and reminders</p>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <p className="text-gray-400 text-xs mt-4" style={{ letterSpacing: '0' }}>
