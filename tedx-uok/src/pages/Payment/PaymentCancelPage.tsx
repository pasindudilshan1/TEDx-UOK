    ...
    <>
      ...
      >
        <div className="max-w-2xl mx-auto text-center">
          ...
          <div className="bg-[#0E0E0E] border border-[#F59E0B] rounded-xl p-8 mb-8">
            <div className="flex items-start space-x-4">
              <svg className="w-8 h-8 text-[#F59E0B] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
              </svg>
              <div className="text-left">
                <h3 className="text-lg font-bold text-white mb-2" style={{ letterSpacing: '0' }}>
                  What happened?
                </h3>
          ...
          {/* Information Box */}
          <div className="bg-[#0E0E0E] border border-[#1F1F1F] rounded-xl p-6 mb-8">
            <h3 className="text-lg font-bold text-white mb-4" style={{ letterSpacing: '0' }}>
              Want to complete your registration?
            </h3>
            <p className="text-gray-300 mb-4" style={{ letterSpacing: '0' }}>
            ...
            <div className="flex items-center justify-center space-x-2 text-[#F59E0B]">
              ...
              <span className="text-sm" style={{ letterSpacing: '0' }}>
          ...
          <div className="mt-12 grid grid-cols-1 sm:grid-cols-2 gap-4">
            <Link
              to="/faq"
              className="bg-[#0E0E0E] border border-[#1F1F1F] rounded-lg p-4 hover:border-[#EB0028] transition-all"
              style={{ textDecoration: 'none' }}
            >
              <h4 className="text-white font-bold mb-2" style={{ letterSpacing: '0' }}>
                Have Questions?
              </h4>
              <p className="text-gray-400 text-sm" style={{ letterSpacing: '0' }}>
                Check our FAQ page
              </p>
            </Link>
