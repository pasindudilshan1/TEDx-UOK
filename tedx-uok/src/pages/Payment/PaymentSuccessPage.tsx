      ...
      >
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 mb-8" style={{ letterSpacing: '0' }}>
            Your registration for <span style={{ color: '#EB0028' }}>TED<sup style={{ color: '#EB0028' }}>x</sup></span> <span style={{ color: '#FFFFFF' }}>UoK</span> has been confirmed.
          </p>

          <div className="bg-[#0E0E0E] border border-[#1F1F1F] rounded-xl p-8 mb-8">
          ...
          <div className="mt-12 text-center">
            <p className="text-gray-500 text-sm mb-2" style={{ letterSpacing: '0' }}>
